...
<body>
    <jsp:include flush="true" page="adminPanel/pages/loginBody.html" />
    ...
    <script src="adminPanel/bower_components/metisMenu/dist/metisMenu.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="adminPanel/dist/js/sb-admin-2.js"></script>

    <!-- funcionalidad -->
    <script src="funcionalidad/backoffice.js"></script>
